...
CREATE TABLE IF NOT EXISTS "da_complaint_detail" (
  "complaint_detail_id" int NOT NULL,
  "user_id" int NOT NULL,
...
CREATE TABLE IF NOT EXISTS "da_diagnosis" (
  ...
  "updated_by" int DEFAULT NULL,
  "updated_at" varchar(45) DEFAULT NULL,
  PRIMARY KEY ("user_id","relative_id","doctor_id","appointment_id")
);
...
CREATE TABLE IF NOT EXISTS "da_prescription" (
  ...
  "scale_id" varchar(255) DEFAULT NULL,
  "potency_id" varchar(255) DEFAULT NULL,
  "dosage_id" varchar(255) DEFAULT NULL,
  "freq_id" varchar(255) DEFAULT NULL,
  ...
  "updated_by" int DEFAULT NULL,
  "updated_at" varchar(45) DEFAULT NULL,
  PRIMARY KEY ("user_id","relative_id","doctor_id","appointment_id","drug_id")
);
...
CREATE TABLE IF NOT EXISTS "dd_mode" (
  ...
  "price_per_min" int DEFAULT NULL,
  "created_at" varchar(45) NOT NULL,
  "updated_at" varchar(45) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "dk_photo" (
  ...
  "photo" mediumtext,
  "created_at" varchar(45) DEFAULT NULL,
  PRIMARY KEY ("id","doctor_id","kit_id")
);
...
CREATE TABLE IF NOT EXISTS "ehr_lifestyle" (
  ...
  "user_id" int NOT NULL,
  "relative_id" int NOT NULL,
  "smoking_id" int DEFAULT NULL,
  "alcohol_id" int DEFAULT NULL,
  "excercise_id" int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "m_current_medication" (
  "current_medication_id" int NOT NULL,
  "name" varchar(45) NOT NULL,
  "is_active" varchar(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "m_post_medication" (
  "post_medication_id" int NOT NULL,
  "name" varchar(45) NOT NULL,
  "is_active" varchar(45) NOT NULL,
